            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <!-- <div>
                        ...
                        <a href="<?= site_url('StafSeksi/update_status/' . esc($pemetaan['id']) . '/terverifikasi'); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('StafSeksi/update_status/' . esc($pemetaan['id']) . '/ditolak'); ?>" class="btn btn-danger">Ditolak</a>
                    </div> -->
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('StafSeksi/pemetaan_swadaya'); ?>" class="btn btn-primary">Kembali</a>
