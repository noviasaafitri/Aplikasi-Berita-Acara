...
<div class="container-fluid d-flex flex-column min-vh-100">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">View Pemetaan Rehab Jaringan</h1>
        ...
        <div class="col-14 grid-margin">
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <p><strong>No. Tanggal BA Perubahan: </strong> <?= esc($pemetaan['nt_ba_perubahan']); ?></p>
                    ...
                    <!-- <div>
                        ...
                        <a href="<?= site_url('StafSeksi/up_status/' . esc($pemetaan['id']) . '/terverifikasi'); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('StafSeksi/up_status/' . esc($pemetaan['id']) . '/ditolak'); ?>" class="btn btn-danger">Ditolak</a>
                    </div> -->
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('StafSeksi/rehab_jaringan'); ?>" class="btn btn-primary">Kembali</a>
