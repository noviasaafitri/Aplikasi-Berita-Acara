...
<body>
    <div class="container">
        ...
        <p class="nomor">Nomor: <?= $pj['no_surat'] ?? 'Tidak Ada'; ?></p>
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <div>Rp.
                    <?= number_format($pj['nilai_pekerjaan'], 0, ',', '.') ?>
                </div>
            </div>
        ...
        <div class="signature-container">
            <div class="signature">
                ...
                <p style="margin: 0; text-decoration: underline;""><strong><b><?= $pj['nama_kepsek'] ?? 'Tidak Ada'; ?></b></strong></p>
                <p>NIK. <?= $pj['nik_kepsek'] ?? 'Tidak Ada'; ?></p>
            </div>
            <div class=" signature">
                <p id="date">Pontianak, ..................</p>
                <p>Diinput Oleh:</p>
                <p class="signature-title">Staf Seksi Data Base Aset</p>
                <p style="margin: 0; text-decoration: underline;""><strong><b><?= $pj['nama_penginput'] ?? 'Tidak Ada'; ?></b></strong></p>
                <p>NIK. <?= $pj['nik_penginput'] ?? 'Tidak Ada'; ?></p>
            </div>
