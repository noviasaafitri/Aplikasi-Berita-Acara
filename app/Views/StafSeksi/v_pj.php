...
<div class="container-fluid d-flex flex-column min-vh-100">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">View Pemetaan Pengembangan Jaringan</h1>
        ...
        <div class="col-14 grid-margin">
            <div class="card shadow">
                <div class="card-header py-3">
                    <p><strong>Nomor Surat: </strong> <?= esc($pemetaan['no_surat']); ?></p>
                    ...
                    <p><strong>No. Tanggal BA Selesai Perubahan: </strong> <?= esc($pemetaan['nt_ba_perubahan']); ?></p>
                    ...
                    <p><strong>Nama Penginput: </strong> <?= esc($pemetaan['nama_penginput']); ?></p>
                    <p><strong>NIK Penginput: </strong> <?= esc($pemetaan['nik_penginput']); ?></p>
                    <p><strong>Nama Kepala Seksi: </strong> <?= esc($pemetaan['nama_kepsek']); ?></p>
                    <p><strong>NIK Kepala Seksi: </strong> <?= esc($pemetaan['nik_kepsek']); ?></p>
                    ...
                    <!-- <div>
                        ...
                        <a href="<?= site_url('StafSeksi/update_st/' . esc($pemetaan['id']) . '/terverifikasi'); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('StafSeksi/update_st/' . esc($pemetaan['id']) . '/ditolak'); ?>" class="btn btn-danger">Ditolak</a>
                    </div> -->
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('StafSeksi/pengembang_jaringan'); ?>" class="btn btn-primary">Kembali</a>
