...
<div class="container-fluid d-flex flex-column min-vh-100">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">View Sipil & Me</h1>
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <!-- <div>
                        ...
                        <a href="<?= site_url('StafSeksi/update_sta/' . esc($pemetaan['id']) . '/terverifikasi'); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('StafSeksi/update_sta/' . esc($pemetaan['id']) . '/ditolak'); ?>" class="btn btn-danger">Ditolak</a>
                    </div> -->
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('StafSeksi/sipil_me'); ?>" class="btn btn-primary">Kembali</a>
