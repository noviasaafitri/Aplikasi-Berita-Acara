...
<div class="container-fluid d-flex flex-column min-vh-100">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Edit Pemetaan Rehab Jaringan - Staf Seksi Database</h1>
    <div class="col">
        <div class="col-14 grid-margin">
            <div class="card shadow">
                <div class="card-body">
                    <form method="POST" action="<?= base_url('StafSeksi/update_rj/' . $pemetaan['id']) ?>" class="form-sample">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div style="text-align: right;">
                                <a href="<?= base_url('StafSeksi/rehab_jaringan'); ?>" class="btn btn-danger">Batal</a>
