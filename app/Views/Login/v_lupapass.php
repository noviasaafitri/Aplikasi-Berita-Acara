                            ...
                            <div class="col-lg-12">
                                <div class="p-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Masukkan alamat email Anda di bawah ini dan kami akan mengirimkan tautan untuk mereset password Anda!</p>
                                    </div>
                                    ...
                                    <?= form_open('auth/proses_forgot_password') ?>
