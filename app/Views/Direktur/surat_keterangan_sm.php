...
<body>
    <div class="container">
        ...
        <p class="nomor">Nomor: <?= $sm['no_surat'] ?? 'Tidak Ada'; ?></p>
        ...
        <form>
                ...
                <div>
                    <div class="checkbox-container">
                        <div class="checkbox-item">
                            <input type="checkbox" <?= in_array("Pengembangan Jaringan Pipa", $jenis_pekerjaan)
                                                        ? 'checked' : '' ?> id="pjp">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" <?= in_array("Rehabilitasi Jaringan Pipa", $jenis_pekerjaan)
                                                        ? 'checked' : '' ?> id="rjp">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" <?= in_array("Perbaikan Kebocoran Pipa", $jenis_pekerjaan) ? 'checked'
                                                        : '' ?> id="pkp">
            ...
            <div class="form-group">
                ...
                <div>Rp.
                    <?= number_format($sm['nilai_pekerjaan'], 0, ',', '.') ?>
                </div>
            </div>
        ...
        <div class="signature-container">
            <div class="signature">
                ...
                <p style="margin: 0; text-decoration: underline;""><strong><b><?= $sm['nama_kespek'] ?? 'Tidak Ada'; ?></b></strong></p>
                <p>NIK. <?= $sm['nik_kespek'] ?? 'Tidak Ada'; ?></p>
            </div>
            <div class=" signature">
                <p id="date">Pontianak, ..................</p>
                <p>Diinput Oleh:</p>
                <p class="signature-title">Staf Seksi Data Base Aset</p>
                <p style="margin: 0; text-decoration: underline;""><strong><b><?= $sm['nama_penginput'] ?? 'Tidak Ada'; ?></b></strong></p>
                <p>NIK. <?= $sm['nik_penginput'] ?? 'Tidak Ada'; ?></p>
            </div>
