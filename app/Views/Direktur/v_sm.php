            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <div>
                        ...
                        <a href="<?= site_url('Direktur/update_status_by_kategori_sm/Sipil & Me/terverifikasi/' . esc($pemetaan['id'])); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('Direktur/update_status_by_kategori_sm/Sipil & Me/ditolak/' . esc($pemetaan['id'])); ?>" class="btn btn-danger">Ditolak</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('Direktur/sipil_me'); ?>" class="btn btn-primary">Kembali</a>
