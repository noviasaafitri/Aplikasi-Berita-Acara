            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <div>
                        ...
                        <a href="<?= site_url('Direktur/update_status_by_kategori_pj/Pemetaan Pengembangan Jaringan/terverifikasi/' . esc($pemetaan['id'])); ?>" class="btn btn-success">Verifikasi</a>
                        <a href="<?= site_url('Direktur/update_status_by_kategori_pj/Pemetaan Pengembangan Jaringan/ditolak/' . esc($pemetaan['id'])); ?>" class="btn btn-danger">Ditolak</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div style="text-align: right;">
                        ...
                        <a href="<?= site_url('Direktur/pengembang_jaringan'); ?>" class="btn btn-primary">Kembali</a>
