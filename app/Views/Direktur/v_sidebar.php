...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Direktur/home') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'home') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/home') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'pemetaan_swadaya') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/pemetaan_swadaya') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'rehab_jaringan') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/rehab_jaringan') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'pengembang_jaringan') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/pengembang_jaringan') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'sipil_me') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/sipil_me') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'berita_acara') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Direktur/berita_acara') ?>">
