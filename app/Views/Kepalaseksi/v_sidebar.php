...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('KepalaSeksi/home') ?>">
        ...
        <!-- <div class="sidebar-brand-text mx-4">berita acara <sup>pdam</sup></div> -->
    </a>
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'home') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('KepalaSeksi/home') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'pemetaan_swadaya') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('KepalaSeksi/pemetaan_swadaya') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'rehab_jaringan') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('KepalaSeksi/rehab_jaringan') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'pengembang_jaringan') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('KepalaSeksi/pengembang_jaringan') ?>">
            <i class="fas fa-fw fa-table"></i>
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'sipil_me') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Kepalaseksi/sipil_me') ?>">
    ...
    <li class="nav-item <?= ($uri->getSegment(2) == 'berita_acara') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('Kepalaseksi/berita_acara') ?>">
